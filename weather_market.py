...
def get_weather_advice(location: str, user_language_context: str = ""):
    """
    Get AI-generated weather advice for farming based on location
    """
    try:
        ...
        if user_language_context:
            language_instruction = f"Important: Respond in the same language as this user input: '{user_language_context[:50]}...'"
...
def get_market_intelligence(user_language_context: str = ""):
    """
    Get AI-generated market tips and insights for farmers
    """
    try:
...
# Keep original function names for backward compatibility
def get_mock_weather(location: str, user_input: str = ""):
    """Wrapper for backward compatibility with language detection"""
    return get_weather_advice(location, user_input)

def get_market_tip(user_input: str = ""):
    """Wrapper for backward compatibility with language detection"""
    return get_market_intelligence(user_input)